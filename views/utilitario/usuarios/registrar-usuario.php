        ...
        <form action="" id="form-person-user">
          ...
          <div class="row g-2 mt-3 contenedor-marcaagua" hidden>
            ...
            <div class="col-sm-5 text-center">
              ...
              <input id="upload_widget_marcaagua" name="upload_widget_marcaagua" type="file" class="btn btn-primary w-100 d-flex align-items-center justify-content-center" accept="image/*">
          ...
          <div class="row g-2 mt-3 contenedor-firma" >
            ...
            <div class="col-sm-5 text-center">
              ...
              <input id="upload_widget_firma" name="upload_widget_firma" type="file" class="btn btn-primary w-100 d-flex align-items-center justify-content-center"  accept="image/*">
                <i class="fa-solid fa-cloud-upload-alt me-2"></i> Seleccionar Archivo
