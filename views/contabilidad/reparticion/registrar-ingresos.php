...
<div class="container-fluid ">
    ...
    -moz-box-shadow: 1px 1px 0px 0px rgba(0,0,0,0.11);">
        <h1 id="titulo-registrar-at-clientes">Registrar Ingreso</h1>
        ...
        <div class="card-footer d-flex justify-content-end">
            <div class="d-flex gap-2">
                <button type="button" id="btnRegistrarNuevoIngreso" class="btn btn-primary text-start">
                    <i class="fa-solid fa-plus px-2"></i>Registra Nuevo Ingreso</button>
    ...
    <div class="modal fade" id="modal-ingreso" tabindex="-1" aria-labelledby="modalingreso" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalingreso">Registra Nuevo Ingreso</h1>
                ...
                <div class="modal-footer text-end">
                    <button type="button" class="btn btn-secondary" id="btnRegistrarIngreso">Guardar</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="http://localhost/vega-erp/js/reparticiones/registrar-ingresos.js"></script>
