...
-- Tiempo de generación: 07-05-2025 a las 14:36:16
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_actualizar_sucursal` (IN `_idsucursal` INT, IN `_idempresa` INT, IN `_iddistrito` INT, IN `_idresponsable` INT, IN `_nombre` VARCHAR(120), IN `_ruc` CHAR(11), IN `_telefono` CHAR(20), IN `_direccion` VARCHAR(120), IN `_email` VARCHAR(120))   BEGIN
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_actualizar_tarifa` (IN `_idtarifario` INT, IN `_precio` INT)   BEGIN 
	UPDATE tarifario SET
    precio = _precio
    WHERE idtarifario = _idtarifario;
END$$

CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_actualizar_usuario` (IN `_idsucursal` INT, IN `_idusuario` INT, IN `_nom_usuario` VARCHAR(30), IN `_claveacceso` VARBINARY(255), IN `_color` CHAR(7), IN `_porcentaje` INT, IN `_marcaagua` VARCHAR(40), IN `_firma` VARCHAR(40))   BEGIN
		UPDATE usuarios 
    SET 
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_filtrar_cajachica` (IN `_fecha_apertura` DATETIME, IN `_fecha_cierre` DATETIME, IN `_mes` INT, IN `_año_semana` INT, IN `_busqueda_general` VARCHAR(255))   BEGIN
    SELECT 
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_registrar_cajachica` (OUT `_idcajachica` INT, IN `_iddetalle_presentacion` INT, IN `_idmonto` INT, IN `_ccinicial` DOUBLE(10,2), IN `_incremento` DOUBLE(10,2), IN `_decremento` DOUBLE(10,2), IN `_ccfinal` DOUBLE(10,2))   BEGIN
    DECLARE existe_error INT DEFAULT 0;
    DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
    BEGIN
        SET existe_error = 1;
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_registrar_comprobante` (OUT `_idcomprobante` INT, IN `_iddetallepresentacion` INT, IN `_idsucursal` INT, IN `_idcliente` INT, IN `_idtipodoc` CHAR(2), IN `_tipopago` INT, IN `_nserie` CHAR(4), IN `_correlativo` CHAR(8), IN `_tipomoneda` VARCHAR(40), IN `_monto` DECIMAL(10,2), IN `_tieneigv` TINYINT)   BEGIN
	    DECLARE existe_error INT DEFAULT 0;
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_registrar_gasto` (OUT `_idgasto` INT, IN `_idcajachica` INT, IN `_concepto` VARCHAR(250), IN `_monto` DOUBLE(10,2))   BEGIN
    DECLARE existe_error INT DEFAULT 0;
    DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
    BEGIN
        SET existe_error = 1;
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_registrar_sucursal` (IN `_idempresa` INT, IN `_iddistrito` INT, IN `_idresponsable` INT, IN `_nombre` VARCHAR(120), IN `_ruc` CHAR(11), IN `_telefono` CHAR(20), IN `_direccion` VARCHAR(120), IN `_email` VARCHAR(120))   BEGIN
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_registrar_tarifa` (OUT `_idtarifario` INT, IN `_idusuario` INT, IN `_idprovincia` INT, IN `_precio` DECIMAL(10,2), IN `_tipo_evento` INT)   BEGIN
	DECLARE existe_error INT DEFAULT 0;
...
CREATE DEFINER=`u321513493_vegaerp`@`127.0.0.1` PROCEDURE `sp_registrar_usuario` (OUT `_idusuario` INT, IN `_idsucursal` INT, IN `_idpersona` INT, IN `_nom_usuario` VARCHAR(120), IN `_claveacceso` VARBINARY(255), IN `_color` CHAR(7), IN `_porcentaje` INT, IN `_marcaagua` VARCHAR(40), IN `_firma` VARCHAR(40), IN `_idnivelacceso` INT)   BEGIN
	DECLARE existe_error INT DEFAULT 0;
	DECLARE CONTINUE HANDLER FOR SQLEXCEPTION
	BEGIN
        SET existe_error = 1;
...
(1, 1, 7, 1, 1, 1, '2025-04-16 18:12:04', '2025-04-16', '19:12:00');
...
(1, NULL, NULL, NULL, 'R.E Kiño', NULL, NULL, NULL, NULL),
...
(17, NULL, NULL, NULL, 'koki', NULL, NULL, NULL, NULL),
...
(3, 17, 1, '2025-05-05 19:53:29', NULL),
(4, 18, 1, '2025-05-05 19:56:38', NULL);
...
INSERT INTO `detalles_presentacion` (`iddetalle_presentacion`, `idusuario`, `idcliente`, `iddistrito`, `ncotizacion`, `fecha_presentacion`, `horainicio`, `horafinal`, `establecimiento`, `referencia`, `acuerdo`, `tipo_evento`, `modalidad`, `modotransporte`, `validez`, `igv`, `reserva`, `pagado50`, `tienecaja`, `estado`, `created_at`) VALUES
(1, 2, 1, 1269, NULL, '2025-04-19', '00:00:00', '00:00:00', 'Local praxigas ex finca Nario', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(2, 3, 1, 1269, NULL, '2025-04-19', '00:00:00', '00:00:00', 'Local praxigas ex finca Nario', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(3, 3, 2, 221, NULL, '2025-04-20', '18:00:00', '21:30:00', 'Aniversario de azucena /pisina', NULL, NULL, 1, 1, 1, NULL, 0, 0, 0, 0, 1, '2025-04-16'),
(4, 2, 3, 1183, NULL, '2025-04-30', '21:00:00', '02:00:00', 'Casa grande Club Gema de Casa grande', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(5, 2, 4, 613, NULL, '2025-05-04', '00:00:00', '00:00:00', NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(6, 2, 4, 1, NULL, '2025-05-04', '00:00:00', '00:00:00', NULL, NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(7, 2, 5, 1577, NULL, '2025-05-31', '12:30:00', '03:00:00', '', NULL, NULL, 1, 1, 1, NULL, 0, 0, 0, 0, 1, '2025-04-16'),
(8, 3, 5, 1577, NULL, '2025-05-31', '22:00:00', '00:00:00', '', NULL, NULL, 1, 1, 1, NULL, 0, 0, 0, 0, 1, '2025-04-16'),
(9, 2, 6, 979, '0001-2025', '2025-04-26', '00:00:00', '04:00:00', 'Sindicato de obreros', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(10, 2, 7, 1183, '0002-2025', '2025-04-27', '01:30:00', '04:00:00', 'Tabaco marino', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(11, 2, 8, 1104, '0003-2025', '2025-05-01', '00:00:00', '00:00:00', 'Recepciones Marcelita muruhuay', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(12, 3, 9, 495, '0004-2025', '2025-05-01', '23:00:00', '03:00:00', 'Centro poblado Santa filomena', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(13, 2, 9, 1342, '0005-2025', '2025-05-03', '16:00:00', '20:00:00', NULL, NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(14, 2, 10, 672, '0006-2025', '2025-05-09', '20:00:00', '22:00:00', NULL, NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(15, 2, 11, 1154, '0007-2025', '2025-05-10', '23:00:00', '01:00:00', 'retamaz', 'fiesta patronal honor a la santisima virgen de la puerta y dia de la madre', '42mil', 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(16, 2, 12, 323, '0043-2025', '2025-05-11', '22:00:00', '02:00:00', 'cerro colorado', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(17, 2, 13, 323, '0008-2025', '2025-05-17', '00:00:00', '00:00:00', 'rio grande iquipi', NULL, NULL, 1, 2, 1, 7, 0, 1, 0, 0, 1, '2025-04-16'),
(18, 2, 13, 326, '0009-2025', '2025-05-18', '00:00:00', '00:00:00', 'estadio municipal', NULL, NULL, 2, 2, 1, 7, 0, 1, 0, 0, 1, '2025-04-16'),
(19, 4, 14, 1034, '0010-2025', '2025-10-25', '00:00:00', '00:00:00', 'huancayo, aun no hay locacion', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-16'),
(20, 2, 15, 964, NULL, '2025-04-13', '22:00:00', '02:00:00', 'discoteca 10 lukas', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(21, 2, 16, 1338, NULL, '2025-04-12', '23:00:00', '03:00:00', 'discoteca tropical', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(22, 2, 17, 1225, NULL, '2025-04-06', '18:00:00', '22:00:00', 'aventura  park 7 aniversario', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(23, 2, 18, 1337, NULL, '2025-04-04', '22:00:00', '00:30:00', 'yacumama', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(24, 2, 19, 1293, NULL, '2025-03-30', '18:00:00', '22:30:00', 'piscina las palmeras', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(25, 2, 20, 1153, NULL, '2025-03-23', '20:00:00', '00:00:00', 'recreo municipal', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(26, 2, 21, 1270, NULL, '2025-03-22', '21:00:00', '01:00:00', 'coco bongo', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(27, 2, 22, 1345, NULL, '2025-03-15', '23:00:00', '03:00:00', 'el aguaje', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(28, 2, 23, 1352, NULL, '2025-03-14', '22:00:00', '01:00:00', 'discoteca anubis boulevard la hacienda', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(29, 2, 24, 1225, NULL, '2025-03-09', '22:00:00', '02:00:00', NULL, 'El día 8 de Marzo día de la Mujer desde las 8 pm hasta las 4 am', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(30, 2, 25, 667, NULL, '2025-03-08', '23:00:00', '03:00:00', 'bailodromo', 'BAILODROMO de la Av. Tomas Valle #Mz E Lt 2 Urb El condor Callao..Callao', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(31, 2, 3, 546, NULL, '2025-03-02', '00:00:00', '00:00:00', 'punta sal', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(32, 2, 17, 1118, NULL, '2025-03-01', '00:00:00', '00:00:00', 'discoteca', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(33, 2, 2, 1568, NULL, '2025-02-16', '22:00:00', '02:00:00', 'coliseo cerrado huadalupe ruiz', NULL, NULL, 1, 1, 1, NULL, 0, 0, 0, 0, 1, '2025-04-16'),
(34, 3, 2, 1568, NULL, '2025-02-16', '18:00:00', '21:00:00', 'coliseo cerrado huadalupe', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(35, 2, 2, 1546, NULL, '2025-02-15', '18:00:00', '21:00:00', 'Calle Bolognesi', 'Calle Bolognesi', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(36, 3, 2, 1546, NULL, '2025-02-15', '21:00:00', '00:00:00', 'calle bolognesi', 'calle bolognesi', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(37, 2, 26, 1547, NULL, '2025-02-15', '00:00:00', '03:00:00', 'yunce rosado \"el progreso\"', 'san martin occidente', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(38, 4, 27, 1293, NULL, '2025-02-09', '17:00:00', '19:30:00', 'piscina las palmeras', 'el valle de anexo 22', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(39, 2, 28, 1338, NULL, '2025-02-09', '16:00:00', '19:00:00', 'piscina el paraiso', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(40, 2, 27, 1293, NULL, '2025-02-09', '20:00:00', '23:00:00', 'piscina las palmeras', 'el valle de anexo 22', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(41, 3, 29, 672, NULL, '2025-02-09', '19:00:00', '21:00:00', 'parasol', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(42, 2, 30, 672, NULL, '2025-02-08', '01:00:00', '04:00:00', 'arius disco', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(43, 2, 31, 1359, NULL, '2025-02-08', '21:00:00', '00:00:00', 'frontis municipalidad', 'feliz 63 aniversario, distrito lugar frontis municipalidad', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(44, 3, 31, 1359, NULL, '2025-02-08', '21:00:00', '00:00:00', 'frontis municipalidad', 'feliz 63 aniversario distrito lugar frontis municipalidad', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(45, 2, 32, 601, NULL, '2025-02-04', '21:00:00', '01:00:00', 'coliseo municipal', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(46, 2, 3, 1115, NULL, '2025-02-02', '15:00:00', '19:00:00', 'playa mal abrigo', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(47, 2, 33, 1563, NULL, '2025-02-01', '22:00:00', '02:00:00', 'calle cristobal', 'calle cristobal colon sin numero a la espalda del mercadillo', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(48, 2, 34, 1183, NULL, '2025-01-28', '00:00:00', '00:00:00', 'coliseo municipal de simbal', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(49, 2, 35, 672, NULL, '2025-01-26', '15:00:00', '19:00:00', 'centro recreacional parasol piscina', 'piscina', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(50, 3, 36, 1804, NULL, '2025-01-20', '21:00:00', '01:00:00', 'club libertad', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(51, 2, 2, 1535, NULL, '2025-01-19', '20:00:00', '00:00:00', 'club deportivo el caysa', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(52, 2, 2, 1537, NULL, '2025-01-19', '15:00:00', '19:00:00', 'calle 2 de mayo', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(53, 4, 37, 1345, NULL, '2025-01-19', '20:00:00', '02:00:00', 'aguaje', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(54, 2, 36, 1578, NULL, '2025-01-18', '21:00:00', '01:00:00', 'mz d1 el san sebastian', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(55, 2, 38, 1128, NULL, '2025-01-17', '23:00:00', '03:00:00', 'local casa vieja', '32 aniversario identica de chepen', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(56, 2, 39, 1570, NULL, '2025-01-13', '22:30:00', '02:30:00', 'fiesta patronal', 'gran fiesta patronal san francisco', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(57, 2, 17, 1203, NULL, '2025-01-12', '15:00:00', '19:00:00', 'playa lagunas mocupe', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(58, 2, 17, 1206, NULL, '2025-01-12', '21:00:00', '00:00:00', NULL, 'feliz aniversario santa rosa', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(59, 2, 40, 1263, NULL, '2025-01-10', '23:00:00', '03:00:00', 'estadio san luis', 'feliz 154 aniversario distrito san luis cañete', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(60, 2, 41, 1355, NULL, '2025-01-05', '21:00:00', '01:00:00', 'el mueble internacional', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(61, 2, 3, 1115, NULL, '2025-01-02', '20:00:00', '01:00:00', 'estadio municipal de chicama', 'Distrito de chicama celebrar 168 años de creación política Local Estadío Municipal de Chicama', NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(62, 2, 42, 971, NULL, '2025-01-01', '22:00:00', '01:00:00', 'piscinazo bailable', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(63, 2, 43, 964, NULL, '2025-01-01', '18:30:00', '21:30:00', 'piscina club el tumi', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-16'),
(65, 2, 44, 1327, '0011-2025', '2025-03-22', '23:00:00', '01:00:00', 'garden palace', NULL, NULL, 2, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(66, 5, 45, 1188, '0012-2025', '2025-03-22', '22:00:00', '00:00:00', NULL, 'cumpleaños sorpresa', NULL, 2, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(67, 2, 46, 672, '0013-2025', '2025-03-16', '16:00:00', '18:00:00', 'aquapark', 'aquapark/ventanilla', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(68, 4, 47, 1104, '0014-2025', '2025-03-11', '00:00:00', '00:00:00', NULL, NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(69, 4, 48, 1707, '0015-2025', '2025-03-01', '21:00:00', '03:00:00', 'San martin de alao - C.P: Sinami', 'San martin de alao - C.P: Sinami', NULL, 2, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(70, 3, 49, 1345, '0016-2025', '2025-02-23', '00:00:00', '00:00:00', 'piscinazo el anden', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(71, 2, 50, 722, '0017-2025', '2025-02-23', '20:00:00', '23:00:00', 'oropeza cusco', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(72, 2, 51, 1793, '0018-2025', '2025-02-22', '22:00:00', '01:00:00', 'el local chololo - pocollay', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(73, 4, 52, 138, '0019-2025', '2025-02-21', '00:00:00', '00:00:00', NULL, NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(74, 4, 53, 1352, '0020-2025', '2025-02-16', '20:00:00', '22:00:00', 'villa de armas - zarate', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(75, 4, 54, 1293, '0021-2025', '2025-02-16', '00:00:00', '00:00:00', 'club el padrino', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(76, 4, 55, 1015, '0022-2025', '2025-02-15', '00:00:00', '00:00:00', NULL, NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(77, 4, 56, 1034, '0023-2025', '2025-02-15', '00:00:00', '00:00:00', 'local mil maravillas', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(78, 2, 57, 1167, '0024-2025', '2025-02-14', '22:00:00', '01:00:00', 'pedregal disco lounge', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(79, 4, 58, 1322, '0025-2025', '2025-02-14', '04:00:00', '06:00:00', 'local angaraes', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(80, 4, 58, 1355, '0026-2025', '2025-02-14', '23:00:00', '01:00:00', 'unicachi', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(81, 4, 58, 1352, '0027-2025', '2025-02-14', '20:00:00', '22:00:00', 'crucero del amor', 'estacion san carlos', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(82, 4, 59, 910, '0028-2025', '2025-02-11', '22:00:00', '00:00:00', 'llata', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(83, 2, 60, 546, '0029-2025', '2025-02-10', '22:00:00', '01:00:00', 'cajabamba', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(84, 4, 61, 1331, '0030-2025', '2025-02-08', '01:00:00', '03:00:00', 'larcay', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(85, 2, 62, 214, '0031-2025', '2025-02-02', '00:30:00', '03:30:00', 'discoteca explanada beta disco', NULL, NULL, 2, 2, 1, 7, 0, 1, 0, 0, 1, '2025-04-21'),
(86, 4, 58, 1352, '0032-2025', '2025-01-25', '00:00:00', '00:00:00', 'crucero del amor', 'estacion san carlos', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(87, 2, 37, 1338, '0033-2025', '2025-01-25', '03:00:00', '04:00:00', 'local mia club', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(88, 4, 63, 1062, '0034-2025', '2025-01-22', '01:00:00', '03:00:00', 'local cour de basket', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(89, 4, 64, 1331, '0035-2025', '2025-01-18', '23:30:00', '00:00:00', 'local ilarcay', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(90, 4, 65, 824, '0036-2025', '2025-01-14', '23:00:00', '02:00:00', 'local plaza principal de paucara', 'plaza principal de paucara', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(91, 4, 66, 1034, '0037-2025', '2025-01-12', '00:30:00', '03:00:00', 'aniversario artista sunqucha', 'aniversario artista sunqucha', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(92, 4, 1, 1490, '0038-2025', '2025-01-11', '21:00:00', '23:00:00', '69 aniversario santa ana de tusi', '69 aniversario santa ana de tusi', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(93, 2, 67, 1345, '0039-2025', '2025-01-05', '03:40:00', '05:40:00', 'piscina chepita royer', 'changrila', NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(94, 4, 68, 824, '0040-2025', '2025-01-02', '21:30:00', '00:30:00', 'villa san francisco', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-21'),
(95, 3, 9, 1104, '0041-2025', '2025-05-01', '23:00:00', '03:00:00', 'Centro poblado Santa filomena', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-04-25'),
(96, 2, 69, 1557, NULL, '2025-05-04', '00:00:00', '00:00:00', 'salsa de la cumbia', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-04-25'),
(97, 8, 70, 1214, NULL, '2025-04-30', '22:00:00', '03:00:00', 'Local de la Institución Educativa Antoni Raimondi de Saltur', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(98, 8, 71, 1183, '0042-2025', '2025-05-01', '18:00:00', '21:00:00', 'Explanada de Huanchaco', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-05-05'),
(99, 8, 72, 214, NULL, '2025-05-01', '00:00:00', '04:00:00', 'beta disco lounge', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(100, 8, 73, 1, NULL, '2025-05-02', '22:00:00', '02:00:00', 'discoteca la hacienda', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(101, 8, 74, 625, NULL, '2025-05-03', '22:00:00', '02:00:00', 'Paramo Centro Recreacional', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(102, 8, 75, 1701, NULL, '2025-05-04', '15:00:00', '18:00:00', 'La Choza CutervinaMedio Dia', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(103, 8, 76, 78, NULL, '2025-05-04', '20:00:00', '00:00:00', 'Discoteca La Hacienda Noche', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(104, 8, 77, 1183, NULL, '2025-05-09', '19:00:00', '03:00:00', 'el barco primer turno', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(112, 8, 85, 1557, NULL, '2025-05-12', '22:00:00', '02:00:00', 'la casa de la cumbia', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(113, 2, 86, 1335, NULL, '2025-05-17', '19:00:00', '03:00:00', 'Estadio Municipal Mi Perú', NULL, NULL, 1, 1, 1, 0, 0, 0, 0, 0, 1, '2025-05-05'),
(117, 8, 88, 1183, '0044-2025', '2025-05-21', '19:00:00', '03:00:00', 'oceania (segundo turno)', NULL, NULL, 1, 2, 1, 7, 0, 0, 0, 0, 1, '2025-05-05');
...
(1, '12345678901', 'vegaimagenes/cyh8cnkpolkljrj2bdyr', 'Razón Social Ejemplo S.A.', 'Nombre Comercial S.A.', 'Vega Producciones', 'Av. Ejemplo 123', 'https://www.ejemplo.com', NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 3, 15000.00, 2, NULL, '2025-05-05', '02:53:38', 1),
(3, 4, 15000.00, 2, NULL, '2025-05-05', '02:56:40', 1);
...
(9, NULL, NULL, 'wendy', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 17:11:48', '2025-05-07 01:54:51'),
(10, '76154707', 'Cornejo', 'Andre', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 17:27:31', NULL),
(11, NULL, NULL, 'caroline', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 19:31:19', NULL),
(12, NULL, 'cotera', 'jasmin', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 19:31:58', NULL),
(13, NULL, 'isique', 'christian', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 19:32:51', NULL),
(14, NULL, 'woody', 'ray', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 19:33:39', NULL),
(15, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-05 19:34:14', NULL),
(16, NULL, NULL, 'omar', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-07 01:54:38', NULL),
(17, NULL, NULL, 'lira', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-07 01:55:07', NULL),
(18, NULL, NULL, 'lenin', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-07 01:55:52', NULL),
(19, NULL, NULL, 'orquidea', NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-07 02:51:57', '2025-05-07 02:52:39');
...
INSERT INTO `sucursales` (`idsucursal`, `idempresa`, `iddistrito`, `idresponsable`, `nombre`, `ruc`, `telefono`, `direccion`, `email`) VALUES
(1, 1, 1, 19, 'Vega Producciones', '20123456789', '012345678', 'Av. Siempre Viva 742', 'contacto@sucursalcentral.com');
...
(1, 1, 3, 1, 'royer', 0x2432792431302464643046374368376d4e726b773245495a4168394675727753596a70513343396441367779536f354d4737354d7a50543149795543, NULL, NULL, NULL, NULL, 1, '2025-04-16 00:31:03', NULL),
(2, 1, 6, 2, 'Azucena Calvay', 0x24327924313024445638732e57654f317171703076616a525a5637517537767375596733524978734d6435636857444e6b7146667071676874526375, '#ff0000', 75, NULL, NULL, 1, '2025-04-16 07:54:32', NULL),
(3, 1, 6, 3, 'Aracely y su alma rebelde', 0x243279243130246e4c53756c6c4d52383562496c47715061743069382e64743051694556637357664269656b555a386b48737a61557a787a31343675, '#7300ff', 30, NULL, NULL, 1, '2025-04-16 07:58:13', NULL),
...
(5, 1, 6, 5, 'Estefany Lozano y su pasion mo', 0x2432792431302431366b336b6f6d747632586a3943372f783856486c755142747465775430384f3573643868494e7667624b365a7651484b3265426d, '#fff700', 70, NULL, NULL, 1, '2025-04-16 08:00:31', NULL),
...
(7, 1, 10, 7, 'andre diseñador', 0x24327924313024466679766e5a2e6d59306351454837336f4a5551324f675a51324e6d537752706c7056585249513361777836484948544e6e6e344b, '#000000', NULL, 'null', 'null', 1, '2025-04-16 18:11:44', '2025-05-05 19:30:11'),
(8, 1, 6, 8, 'Nataly Ramirez', 0x24327924313024616572664d507454634d676172652f616b726c5a314f6c637544744a7a58305179504a634c6a52496c6d5235314a4d625a6b626161, '#0091ff', 50, NULL, NULL, 1, '2025-05-05 09:55:44', NULL),
(9, 1, 3, 9, 'wendy admin', 0x243279243130242e565555314c6f6457524543466e4e6637384870724f6670334b7a51775a7454626a593066594847755134574d4e6571587a7a742e, '#000000', NULL, NULL, NULL, 1, '2025-05-05 17:11:48', NULL),
(11, 1, 10, 11, 'caroline editora', 0x24327924313024616a39703873504353552e36694e4a7a354f6665652e3474654a704765593451533854444a7937306837765257334d4278322f3971, '#000000', NULL, NULL, NULL, 1, '2025-05-05 19:31:19', NULL),
(12, 1, 8, 12, 'jasmin community', 0x2432792431302452496441734e574464556e30707070363837372e677572652f66342f42796650343539766f50643976305a582f517439302f685332, '#000000', NULL, NULL, NULL, 1, '2025-05-05 19:31:59', NULL),
(13, 1, 11, 13, 'christian', 0x24327924313024437432625438746939304e58366f756962364b4375655078324a4e55467a335174595a4441696b307a4b6d5551427a35556a4f6d2e, '#000000', NULL, NULL, NULL, 1, '2025-05-05 19:32:52', NULL),
(14, 1, 11, 14, 'ray', 0x24327924313024714d7452502e726a583353427574753754654f78684f6c5a496e67694f594b757459534a74726c6530653471377558564f454c7353, '#000000', NULL, NULL, NULL, 1, '2025-05-05 19:33:40', NULL),
(15, 1, 11, 15, 'johan', 0x243279243130242f7245314a692f654d496c524667357670344436394f32477a6e503859455776305856506e52324241685830353868363447635147, '#000000', NULL, NULL, NULL, 1, '2025-05-05 19:34:14', NULL),
(16, 1, 3, 16, 'omar admin', 0x24327924313024696e2e5643596f3375437374336666505853363864754766317936372f5834384c776a57486e75717551304d4376372e45566a5657, '#000000', NULL, 'null', 'null', 1, '2025-05-07 01:54:38', '2025-05-07 01:55:19'),
(17, 1, 3, 17, 'lira admin', 0x243279243130243770596337574239576a474969624d42744c4f386c4f3267745869624c376c514c65744e326d322f53643947685a64446e39597165, '#000000', NULL, NULL, NULL, 1, '2025-05-07 01:55:07', NULL),
(18, 1, 3, 18, 'lenin', 0x2432792431302469464758746b49454330554755707a526e744376564f506f4352545575797242746f784d5934375975594c4b39522f574478547053, '#000000', NULL, NULL, NULL, 1, '2025-05-07 01:55:52', NULL),
(19, 1, 3, 19, 'orquidea vega', 0x243279243130244a786b32503648754f54423665685a5558384d3573754b4538367067384d5841556c786a564f312f4961752f4d5a35494375354a47, '#000000', NULL, NULL, NULL, 1, '2025-05-07 02:51:57', NULL);
...
--
ALTER TABLE `agenda_edicion`
  MODIFY `idagendaedicion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `agenda_editores`
--
ALTER TABLE `agenda_editores`
  MODIFY `idagendaeditor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `precios_entrada_evento`
  MODIFY `idprecioentradaevento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `responsables_boleteria_contratoreservasreservas`
  MODIFY `idresponsablecontrato` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tareas_diarias`
  MODIFY `idtareadiaria` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tareas_diaria_asignacion`
--
ALTER TABLE `tareas_diaria_asignacion`
  MODIFY `idtaradiariaasig` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tarifario`
--
ALTER TABLE `tarifario`
  MODIFY `idtarifario` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `gastos_cajachica`
  ADD CONSTRAINT `fk_idcaja_gastos` FOREIGN KEY (`idcajachica`) REFERENCES `cajachica` (`idcajachica`);
