...
insert  into `agenda_asignaciones`(`idasignacion`,`iddetalle_presentacion`,`idusuario`) values 
(1,121,9);
...
(2,1,NULL,'12345678','sol del norte isaias',NULL,NULL,NULL,NULL),
...
insert  into `conceptos`(`idconcepto`,`concepto`) values 
(1,'oficina'),
(2,'ventas'),
(3,'costos'),
(4,'videoclips'),
...
(16,142,0.00,0.00,60,40,'',1,'2025-05-27 11:06:40',NULL);
...
(139,8,3,1573,'0063-2025','2025-05-06','19:00:00','03:00:00','talara',NULL,NULL,2,2,1,7,0,0,0,0,1,'2025-05-22',0,31,1,1),
(141,8,NULL,1183,'0064-2025','2025-05-21','19:00:00','03:00:00','oceania (segundo turno)',NULL,NULL,1,2,1,7,0,0,0,0,3,'2025-05-27',0,1,0,0),
(142,2,1,1335,NULL,'2025-03-31','02:00:00','03:00:00','neverland',NULL,NULL,1,1,1,NULL,0,0,0,0,1,'2025-05-27',0,31,0,0);
...
CREATE TABLE `egresos_evento` (
  ...
  CONSTRAINT `fk_idreparticion_egre` FOREIGN KEY (`idreparticion`) REFERENCES `reparticion_ingresos` (`idreparticion`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
insert  into `gastos_cajachica`(`idgasto`,`idcajachica`,`fecha_gasto`,`concepto`,`monto`) values 
(1,2,'2025-05-09 17:55:25','Viático de Filmmaker ray acca:\r\nHospedaje: S/. 14.00\r\nDesayuno: S/. 13.30\r\nAlmuerzo: S/. 13.30\r\nCena: S/. 13.30',53.90),
(2,2,'2025-05-10 13:18:07','Viático de Filmmaker ray acca:\r\nHospedaje: S/. 333.00\r\nDesayuno: S/. 13.30\r\nAlmuerzo: S/. 13.30\r\nCena: S/. 13.30',372.90),
(3,2,'2025-05-10 13:21:59','Viático de Filmmaker ray acca:\r\nHospedaje: S/. 555.00\r\nDesayuno: S/. 13.30\r\nAlmuerzo: S/. 13.30\r\nCena: S/. 13.30',594.90);

/*Table structure for table `gastosentradas` */

DROP TABLE IF EXISTS `gastosentradas`;

CREATE TABLE `gastosentradas` (
  `idgastoentrada` int(11) NOT NULL AUTO_INCREMENT,
  `estadopago` int(11) DEFAULT NULL,
  `fgasto` date DEFAULT NULL,
  ...
  `cunitario` decimal(10,2) DEFAULT NULL,
  ...
  `foliofactura` varchar(13) DEFAULT NULL,
  `emision` date DEFAULT NULL,
  `descripcion` text DEFAULT NULL,
  `costofinal` decimal(10,2) DEFAULT NULL,
  `egreso` decimal(10,2) DEFAULT NULL,
  `montopdte` decimal(10,2) DEFAULT NULL,
  `impuestos` decimal(10,2) DEFAULT NULL,
  `costofinalunit` decimal(10,2) DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp(),
...
(3,2,'paaaaaa','2025-05-24',33333.00,NULL,5,2,'hhj','comprobantes_vegaproducciones/yvamfph8htb9fwdv5iak','comprobantes_vegaproducciones/h3pwhedlaqwile0qhcbd'),
...
CREATE TABLE `ingresos_evento` (
  ...
  CONSTRAINT `fk_idreparticion_ing` FOREIGN KEY (`idreparticion`) REFERENCES `reparticion_ingresos` (`idreparticion`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `nominas` (
  ...
  KEY `fk_idcolaborador_nomina` (`idcolaborador`),
...
insert  into `nominas`(`idnomina`,`idcolaborador`,`tipo`,`fechaingreso`,`idcargo`,`ruc`,`clavesol`,`ncuenta`) values 
(1,1,1,'2025-05-20',1,'adasd','adsad','adasd'),
(2,10,1,'2025-06-20',2,'asdasd','asdasd','sadads'),
(3,11,1,'2025-05-20',2,'sadasds','sdad','sad');
...
(161,9,1,3,1,'Has sido asignado a un nuevo evento, revisa tu agenda',1,'2025-05-09 12:31:29'),
(162,1,9,1,1,'ray ha reportado un viático, haz click para ver',1,'2025-05-09 17:55:25'),
(163,1,1,5,1,'Se ha configurado precios para el evento de Azucena Calvay - Local praxigas ex finca Nario 19 de Abril de 2025',1,'2025-05-10 09:52:59'),
(164,6,1,5,1,'Se ha configurado precios para el evento de Azucena Calvay - Local praxigas ex finca Nario 19 de Abril de 2025',1,'2025-05-10 09:52:59'),
(165,1,1,5,2,'Se ha configurado precios para el evento de Aracely y su alma rebelde - Local praxigas ex finca Nario 19 de Abril de 2025',1,'2025-05-10 09:58:36'),
(166,6,1,5,2,'Se ha configurado precios para el evento de Aracely y su alma rebelde - Local praxigas ex finca Nario 19 de Abril de 2025',1,'2025-05-10 09:58:36'),
(167,1,1,5,3,'Se ha configurado precios para el evento de Aracely y su alma rebelde - Aniversario de azucena /pisina 20 de Abril de 2025',1,'2025-05-10 10:05:00'),
(168,6,1,5,3,'Se ha configurado precios para el evento de Aracely y su alma rebelde - Aniversario de azucena /pisina 20 de Abril de 2025',1,'2025-05-10 10:05:00'),
(169,8,1,2,NULL,'Royer Alexis Te ha asignado a un nuevo evento para el 11 de Mayo de 2025!, revisa tu agenda.',1,'2025-05-10 10:07:46'),
(170,2,1,2,NULL,'Royer Alexis Te ha asignado a un nuevo evento para el 11 de Mayo de 2025!, revisa tu agenda.',1,'2025-05-10 10:29:28'),
(171,8,1,2,138,'Royer Alexis Te ha asignado a un nuevo evento para el 11 de Mayo de 2025!, revisa tu agenda.',1,'2025-05-10 10:38:39'),
(172,1,8,2,1,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 11:00 AM, click para mas detalles',1,'2025-05-10 11:00:14'),
(173,6,8,2,1,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 11:00 AM, click para mas detalles',1,'2025-05-10 11:00:14'),
(174,1,8,2,2,'Nataly Ramirez ha acaba de retornar el 10 de Mayo de 2025 a las 11:05 AM, click para mas detalles',1,'2025-05-10 11:05:01'),
(175,6,8,2,2,'Nataly Ramirez ha acaba de retornar el 10 de Mayo de 2025 a las 11:05 AM, click para mas detalles',1,'2025-05-10 11:05:01'),
(176,1,9,1,2,'ray ha reportado un viático, haz click para ver',1,'2025-05-10 13:18:08'),
(177,6,9,1,3,'ray ha reportado un viático, haz click para ver',1,'2025-05-10 13:21:59'),
(178,1,8,2,3,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 2:43 PM, click para mas detalles',1,'2025-05-10 14:43:38'),
(179,1,8,2,4,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 2:43 PM, click para mas detalles',1,'2025-05-10 14:43:38'),
(180,6,8,2,4,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 2:43 PM, click para mas detalles',1,'2025-05-10 14:43:38'),
(181,6,8,2,3,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 2:43 PM, click para mas detalles',1,'2025-05-10 14:43:38'),
(182,1,8,2,5,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 3:02 PM, click para mas detalles',1,'2025-05-10 15:02:02'),
(183,6,8,2,5,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 3:02 PM, click para mas detalles',1,'2025-05-10 15:02:02'),
(184,1,8,6,6,'Nataly Ramirez ha acaba de retornar el 10 de Mayo de 2025 a las 3:11 PM, click para mas detalles',1,'2025-05-10 15:11:00'),
(185,6,8,6,6,'Nataly Ramirez ha acaba de retornar el 10 de Mayo de 2025 a las 3:11 PM, click para mas detalles',1,'2025-05-10 15:11:01'),
(186,1,8,6,7,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 3:12 PM, click para mas detalles',1,'2025-05-10 15:12:41'),
(187,6,8,6,7,'Nataly Ramirez ha acaba de salir el 10 de Mayo de 2025 a las 3:12 PM, click para mas detalles',1,'2025-05-10 15:12:41'),
...
CREATE TABLE `pagos_contrato` (
  ...
  CONSTRAINT `fk_idcontrato` FOREIGN KEY (`idcontrato`) REFERENCES `contratos` (`idcontrato`) ON DELETE CASCADE,
...
(1,'72754752','Avalos Romero','Royer Alexis','M','Asent. H. Fe y Alegria Mz D Lt 08','973189350',NULL,'royer.190818@email.com',1335,'2025-04-16 00:31:03','2025-05-15 11:54:48'),
...
(9,NULL,'acca','ray',NULL,NULL,NULL,NULL,NULL,NULL,'2025-05-09 12:28:19','2025-05-09 12:29:14'),
(10,'72767574','Avalos Test','Royer Test','M','AV FALSA 777','999888333',NULL,NULL,955,'2025-05-15 09:46:22',NULL),
(11,'727868521','Prueba Apel','Prueba Nom',NULL,NULL,NULL,NULL,NULL,1335,'2025-05-15 11:11:53','2025-05-15 11:54:26'),
...
insert  into `personas_colaboradores`(`idpersonacolaborador`,`nombreapellidos`,`dni`,`fnacimiento`,`estadocivil`,`sexo`,`domicilio`,`correo`,`nivelestudio`,`contactoemergencia`,`discapacidad`) values 
(1,'asdaasd','1231321','2025-06-20',1,'M','sdasdsada','dasdasdad','sdadasdsad','asasd2112313','asasdasd'),
(2,'ombre test','7272771','2025-06-26',1,'M','adasdad','ale@gmadas.com','adasda','sadasdads','dasdsadasd'),
(3,'test 2','72771237','2026-06-26',1,'M','123sddsad','ssa aroba','secu completa','999933312323 Madre','no hay'),
(4,'adasdads','7371273','2025-06-25',5,'F','adasdadsad','sasdsad','sdadsad','adasd','sdads'),
(5,'dadsasad','sadadsad','2025-05-23',2,'M','sasdsadad','asdasdsad','sdadasd','sdasdasd','asdasd'),
(6,'dadasdsad','dadsd','2025-06-29',1,'M','dsdadas','dda','dadads','sdasdasd','sadasd'),
(7,'asdasdsad','assad','2025-05-20',1,'M','adsdad','sajdoasdo','sodaosjd','sodajod','ojsaodjasd'),
(8,'asasddn','nsadnasj','2025-05-20',1,'M','dadasd','asadasdasd','asdasd','asdasd','sadsad'),
(9,'dasdasd','aasdasd','2025-06-20',1,'M','dadasda','dsadasda','sdasdasdasd','asdad','adsadsad'),
(10,'djsodasodj','iajsdoas','2025-06-20',1,'M','adasdad','dsadads','adasd','saad','sadasd'),
(11,'mvcvxcv','askadkm','2025-05-20',1,'M','asdjasd','sdasnd','sadsd','asdasd','dsadad'),
(12,'adadasd','nsdin','2025-05-20',1,'M','asdadsad','sadssd','sdsad','dsadad','dsdsd'),
(13,'sadhsad','sadnadn','2025-05-20',1,'M','dadasdasd','sdasd','dsdads','adasd','asdasd');
...
CREATE TABLE `precios_entrada_evento` (
  ...
  CONSTRAINT `fk_iddp_entrada_convenio` FOREIGN KEY (`iddetalle_presentacion`) REFERENCES `detalles_presentacion` (`iddetalle_presentacion`) ON DELETE CASCADE
...
(2,'NAMETWO',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(3,'TESTempresa','TESTnombre',999333222,'TESTcorreo',NULL,'BCP',2147483647,'VENTA DE TODO','12344567890012321312323'),
(4,'TEST2empresa','TEST2empresa',NULL,'Test2coreo','2147483647','INTERBANK',2147483647,'venta de entradas','123456789123456789'),
(5,'TEST3empresa','TEST3nombre',936439633,'TEST3correo','2147483647','VISA',2147483647,'VENTA DE BOLETOS WEB','N0231920SZMM'),
(6,'probando nuevo','2',NULL,NULL,'2','12',2,'12','12');
...
(1,97,1,'2025-05-10','11:00:14'),
(2,121,2,'2025-05-10','11:05:00'),
(3,97,1,'2025-05-10','14:43:38'),
(4,97,1,'2025-05-10','14:43:38'),
(5,98,1,'2025-05-10','15:02:02'),
(6,97,2,'2025-05-10','15:11:00'),
(7,100,1,'2025-05-10','15:12:40'),
(8,97,1,'2025-05-10','15:48:21'),
(9,97,1,'2025-05-10','17:18:05');
...
CREATE TABLE `reservas` (
  ...
  CONSTRAINT `fk_idpagocontrato_res` FOREIGN KEY (`idpagocontrato`) REFERENCES `pagos_contrato` (`idpagocontrato`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `responsables_boleteria_contratoreservasreservas` (
  ...
  KEY `fk_iddetalle_presentacion_rbc` (`iddetalle_presentacion`),
  CONSTRAINT `fk_iddetalle_presentacion_rbc` FOREIGN KEY (`iddetalle_presentacion`) REFERENCES `detalles_presentacion` (`iddetalle_presentacion`) ON DELETE CASCADE,
...
insert  into `subidas_agenda_edicion`(`idsubida`,`idagendaeditor`,`url`,`observaciones`) values 
(1,2,'hola.com',NULL);
...
CREATE TABLE `subtipos` (
  ...
  KEY `fk_idsubtipo` (`idconcepto`),
  CONSTRAINT `fk_idsubtipo` FOREIGN KEY (`idconcepto`) REFERENCES `conceptos` (`idconcepto`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `subtipos` */

insert  into `subtipos`(`idsubtipo`,`idconcepto`,`subtipo`) values 
(1,1,'renta oficina'),
(2,1,'nomina'),
(3,1,'material oficina'),
(4,1,'gastos oficina'),
(5,1,'capacitacion'),
(6,1,'gasolina'),
(7,1,'cursos'),
(8,1,'seguro camioneta'),
(9,1,'servicios'),
(10,2,'publicidad'),
(11,2,'envio'),
(12,2,'subcontratacion'),
(13,2,'pagina web'),
(14,2,'mensualidad'),
(15,2,'anualidad'),
(16,2,'subscripcion'),
...
CREATE TABLE `viaticos` (
  ...
  CONSTRAINT `fk_iddp_viatico` FOREIGN KEY (`iddetalle_presentacion`) REFERENCES `detalles_presentacion` (`iddetalle_presentacion`) ON DELETE CASCADE,
  CONSTRAINT `fk_idusuario_v` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `viaticos` */

insert  into `viaticos`(`idviatico`,`iddetalle_presentacion`,`idusuario`,`pasaje`,`hospedaje`,`desayuno`,`almuerzo`,`cena`) values 
(1,121,9,NULL,14.00,1,1,1),
(2,121,9,NULL,333.00,1,1,1),
(3,121,9,NULL,555.00,1,1,1);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualizar_colaborador`(
...
/* Procedure structure for procedure `sp_actualizar_proveedor` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_actualizar_proveedor` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualizar_proveedor`(
	IN _idproveedor			INT,
...
/* Procedure structure for procedure `sp_actualizar_salario` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_actualizar_salario` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualizar_salario`(
	IN _idsalario INT,
...
/* Procedure structure for procedure `sp_buscar_persona_por_numdoc_colaborador` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_buscar_persona_por_numdoc_colaborador` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_buscar_persona_por_numdoc_colaborador`(
	IN _num_doc VARCHAR(20)
)
BEGIN
	SELECT 
...
/* Procedure structure for procedure `sp_filtrar_colaboradores` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtrar_colaboradores` */;
...
/* Procedure structure for procedure `sp_filtrar_gastos` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtrar_gastos` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtrar_gastos`(
    IN _idproveedor INT,
    IN _fgasto DATE
)
BEGIN
...
/* Procedure structure for procedure `sp_filtrar_proveedores` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtrar_proveedores` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtrar_proveedores`(
    IN _nombre VARCHAR(120),
    IN _dni CHAR(15)
)
BEGIN
...
/* Procedure structure for procedure `sp_filtrar_salarios` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_filtrar_salarios` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_filtrar_salarios`(
	IN _idcolaborador INT
	-- IN _nombres VARCHAR(100),
	-- IN _num_doc VARCHAR(20)
)
...
/* Procedure structure for procedure `sp_obtener_colaborador_por_id` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_obtener_colaborador_por_id` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_colaborador_por_id`(
	IN _idcolaborador INT
)
BEGIN
	SELECT 
...
/* Procedure structure for procedure `sp_obtener_fecha_ocupada_artista` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_obtener_fecha_ocupada_artista` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_fecha_ocupada_artista`(
    IN _idusuario INT, 
    IN _fecha_presentacion DATE
)
BEGIN
...
/* Procedure structure for procedure `sp_obtener_notificacion_dp_individual` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_obtener_notificacion_dp_individual` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_notificacion_dp_individual`(
    IN _idreferencia INT
)
BEGIN
	SELECT 
...
/* Procedure structure for procedure `sp_obtener_salario_por_colaborador` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_obtener_salario_por_colaborador` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_salario_por_colaborador`(
	IN _idcolaborador INT
)
BEGIN
	SELECT 
...
/* Procedure structure for procedure `sp_obtener_ultimanomina_por_colaborador` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_obtener_ultimanomina_por_colaborador` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtener_ultimanomina_por_colaborador`(
	IN _idcolaborador INT
)
BEGIN
	SELECT * 
...
/* Procedure structure for procedure `sp_registrar_colaborador` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_registrar_colaborador` */;
...
/* Procedure structure for procedure `sp_registrar_gasto_entrada` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_registrar_gasto_entrada` */;
...
/* Procedure structure for procedure `sp_registrar_gasto_nomina` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_registrar_gasto_nomina` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_registrar_gasto_nomina`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_registrar_proveedor`(
...
/* Procedure structure for procedure `sp_registrar_salario` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_registrar_salario` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_registrar_salario`(
    OUT _idsalario INT,
    IN _idcolaborador int,
    IN _salario DECIMAL(10,2),
	IN _periodo INT,
