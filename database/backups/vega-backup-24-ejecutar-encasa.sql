...
CREATE TABLE `gastosyentradas` (
  ...
  `comprobante_fac_bol` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idgastoentrada`),
...
BEGIN
    ...
    -- Insertar la notificación
    INSERT INTO gastosyentradas (concepto, fecha_gasto, monto, tipo, iddetallepresentacion, idusuario, mediopago, detalles, comprobanteurl, comprobante_fac_bol)
