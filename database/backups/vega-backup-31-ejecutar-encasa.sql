...
BEGIN
    ...
    -- Insertar la notificación
    INSERT INTO nominas (idpersonacolaborador, tipo, fechaingreso, idcargo, ruc, clavesol, ncuenta)
    VALUES (nullif(_idpersonacolaborador,'') , nullif(_tipo,''), nullif(_fechaingreso,''), nullif(_idcargo,''), nullif(_ruc,''), nullif(_clavesol, '') , nullif(_ncuenta, ''));
