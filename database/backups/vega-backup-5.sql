...
insert  into `agenda_editores`(`idagendaeditor`,`idagendaedicion`,`idusuario`,`idtipotarea`,`estado`,`fecha_asignacion`,`fecha_entrega`,`hora_entrega`) values 
(1,1,7,1,1,'2025-04-16 18:12:04','2025-04-16','19:12:00');
...
(85,2,62,214,'0031-2025','2025-02-02','00:30:00','03:30:00','discoteca explanada beta disco',NULL,NULL,2,2,1,7,0,0,0,0,1,'2025-04-21'),
...
CREATE TABLE `empresa` (
  ...
  `logoempresa` varchar(40) DEFAULT NULL,
  ...
  `usuariosol` char(8) DEFAULT NULL,
  `clavesol` char(12) DEFAULT NULL,
...
insert  into `empresa`(`idempresa`,`ruc`,`logoempresa`,`razonsocial`,`nombrecomercial`,`nombreapp`,`direccion`,`web`,`usuariosol`,`clavesol`,`certificado`) values 
(1,'12345678901','vegaimagenes/cyh8cnkpolkljrj2bdyr','Razón Social Ejemplo S.A.','Nombre Comercial S.A.','Vega Producciones','Av. Ejemplo 123','https://www.ejemplo.com','SOL12345','Clave1234','CertificadoEmpresa');
