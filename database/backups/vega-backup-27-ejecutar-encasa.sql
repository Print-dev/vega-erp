...
CREATE TABLE `colaboradores` (
  ...
  KEY `fk_idresponsable_colaborador` (`idresponsable`),
...
insert  into `colaboradores`(`idcolaborador`,`idpersona`,`idsucursal`,`fechaingreso`,`idarea`,`activo`,`idresponsable`,`banco`,`ncuenta`) values 
(1,1,1,'2025-01-01',1,1,NULL,NULL,NULL),
(2,14,1,'2025-02-28',1,1,NULL,NULL,NULL),
(3,15,1,'2025-04-27',2,1,NULL,NULL,NULL),
(4,16,1,'2025-04-01',5,1,NULL,NULL,NULL),
(5,20,1,'2025-05-14',1,1,10,1,'123');
...
CREATE TABLE `nominas` (
  ...
  `nivelestudio` varchar(150) DEFAULT NULL,
