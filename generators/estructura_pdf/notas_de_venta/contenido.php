...
<body>
    ...
    <table class="factura-header">
        <tr>
            ...
            <td class="info-cell">
                <div class="cuadro">
                    <div><strong>NOTA DE VENTA</strong></div>
        ...
        <tr>
            ...
            <td colspan="2" class="empresa-info">
                <div><strong>Razon Social: <?= $infoEmpresa[0]['razonsocial'] ?></strong> </div>
                <div><strong>Dirección: <?= $infoEmpresa[0]['direccion'] ?></strong> </div>
                <div><strong>N° Celular: <?= $infocomprobante[0]['telefono_sucursal'] ?></strong> </div>
                <div><strong>Sucursal/Ubigeo: <?= $infocomprobante[0]['departamento'] . ' - ' . $infocomprobante[0]['provincia'] . ' - ' . $infocomprobante[0]['distrito'] ?></strong> </div>
            </td>
        </tr>
    </table>
    <div class="cliente">
    ...
    <?php } ?>
    <br>
    <strong>Representación Impresa de la NOTA DE VENTA*</strong>
</body>