document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function registrarColaborador(idpersona) {
        ...
        colaborador.append("idpersona", idpersona);
        colaborador.append("fechaingreso",  $q("#fechaingreso").value || '');
        colaborador.append("area", $q("#area").value || '');
        colaborador.append("nivel", $q("#nivel").value || '');
