document.addEventListener("DOMContentLoaded", async () => {
    ...
    function renderizarDatosUsuario(usuario) {
      ...
      async function actualizarUsuario(idusuario, marcaagua) {
        ...
        body.append("marcaagua", marcaagua ? marcaagua : '');
    ...
    $q("#btnActualizarUsuario").addEventListener("click", async () => {
     try {
      ...
      const usuario = await actualizarUsuario(idusuario, imagen_public_id)
