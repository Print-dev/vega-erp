 ...
 */
   ...
   */
    ...
    function createTable(data) {
        let rows = $("#tb-body-notadeventa").find("tr");
        ...
        if (data.length > 0) {
            if (myTable) {
                ...
                myTable = $("#table-notasdeventa").DataTable({
                    paging: true,
                    searching: false,
    ...
    function changeByFilters() {
        ...
        $q("#table-notasdeventa tbody").innerHTML = "";
        filters.forEach((x) => {
    ...
    async function dataFilters() {
        const params = new URLSearchParams();
        params.append("operation", "filtrarNotasDeVenta");
